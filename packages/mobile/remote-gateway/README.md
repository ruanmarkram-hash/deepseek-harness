---
description: "Dispatch authenticated remote requests and ordered Host events through trusted connections."
...
- [Surface](#surface)
- [Connection provider requirement](#connection-provider-requirement)
...
<a id="connection-provider-requirement"></a>
