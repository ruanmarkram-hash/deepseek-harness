...
}) satisfies z.ZodType<Wire<ResponseValue<'subagent.history'>>>
...
}) satisfies z.ZodType<Wire<RequestPayload<'subagent.prompt'>>>
...
const messageIdSchema = z.string().transform(brandString<MessageId>)
