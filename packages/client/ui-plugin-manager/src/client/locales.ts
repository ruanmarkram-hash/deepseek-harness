...
export const zh = {
  ...
  title: '插件',
  intro: '添加和管理插件',
  hostedIntro: '管理此 Mac 上已签名 DSH Host 的插件',
  hostedRequired: '内置',
  hostedRequiredReason: '此插件内置于已签名的 Host。其启用状态由 Host 配置决定，不能在此切换。',
  hostedDownloaded: '已下载',
  loading: '正在读取插件…',
...
export const en = {
  ...
  hostedIntro: 'Manage plugins in the signed DSH Host on this Mac',
  hostedRequired: 'Built-in',
  hostedRequiredReason: 'This plugin is part of the signed Host. Its enabled state is set by the Host profile and cannot be switched here.',
  hostedDownloaded: 'Downloaded',
