...
export const zh = {
  ...
  hostedRequired: '必需',
  hostedRequiredReason: '此插件为 Host 正常运行所必需，不能关闭。',
...
export const en = {
  ...
  hostedRequired: 'Required',
  hostedRequiredReason: 'This plugin is required for the Host to work and cannot be switched off.',
