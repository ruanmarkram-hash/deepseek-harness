...
存储 route 上的 Host device identity 是否相等，与 Host enrollment incarnation 是否相等相互独立。两者均以布尔值呈现；仅有不匹配不能授权替换。单独的[受保护修复](2026-09-23-guarded-same-phone-enrollment-repair.zh.md) 还会证明原生 credential 与当前受保护 Host 匹配。
