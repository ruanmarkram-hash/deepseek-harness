...
describe('translation scope discovery', () => {
  it.each([
    ...
    'native/remote-host-app/README.md',
    'native/remote-host-app/desktop-shell/README.md',
  ...
  it.each([
    ...
    'native/remote-host-app/dist/pinned-node/README.md',
    'native/remote-host-app/desktop-shell/release/runtime/README.md',
