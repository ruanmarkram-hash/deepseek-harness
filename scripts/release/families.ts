...
export abstract class ReleaseFamily {
  ...
  members(root: string): ReleaseMember[] {
    ...
    for (const manifestPath of manifestPaths) {
      ...
      // A private workspace can participate in development and CI without
      // becoming an npm release member. In particular, product shells are
      // distributed as desktop/mobile artifacts rather than tarballs.
