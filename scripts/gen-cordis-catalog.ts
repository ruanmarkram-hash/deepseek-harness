...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planMode: 'plan.md',
  remoteDevices: 'mobile.md',
  remoteEnrollment: 'mobile.md',
  remoteGateway: 'mobile.md',
  remoteHostIdentity: 'mobile.md',
  remoteHostV3: 'mobile.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  fd199AuthorityClient: 'not an injectable service: optional hosted-launch authority channel boot-context value — docs/subsystems/mobile.md owns the mobile package contract',
  fd199DesktopWriteFence: 'not an injectable service: optional hosted-launch desktop write-fence boot-context value — docs/subsystems/mobile.md owns the mobile package contract',
  fd199WebOwner: 'not an injectable service: optional configured-Web ownership exporter boot-context value — docs/subsystems/mobile.md owns the mobile package contract',
  remoteHostV3Native: 'not an injectable service: optional signed Host handoff boot-context value — docs/subsystems/mobile.md owns the mobile package contract',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'remote-devices': 'mobile.md',
  'remote-gateway': 'mobile.md',
  'session': 'session.md',
  'settings': 'settings.md',
  'skills': 'skills.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RemoteDeviceChange: 'mobile.md',
  RemoteDeviceEnrollment: 'mobile.md',
  RemoteDeviceId: 'mobile.md',
  RemoteDeviceRecord: 'mobile.md',
  RemoteEnrollmentConfirmation: 'mobile.md',
  RemoteEnrollmentRoute: 'mobile.md',
  RemoteGatewayConnection: 'mobile.md',
  RemoteGatewayAuditEntry: 'mobile.md',
  RemoteGatewaySnapshot: 'mobile.md',
  RemoteHostPublicIdentity: 'mobile.md',
  RemoteHostV3NativeProvider: 'mobile.md',
  RemoteHostV3Route: 'mobile.md',
  RemoteHostV3RuntimePipe: 'mobile.md',
  RemoteWireId: 'mobile.md',
  RemoteWireResult: 'mobile.md',
  RpcMethodMap: 'typert.md',
  TrustedRemoteConnection: 'mobile.md',
  TrustedRemoteConnectionProvider: 'mobile.md',
  TrustedRemotePeerIdentity: 'mobile.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PluginList: 'signed Host plugin catalog is owned by packages/host/hosted-plugin-controls/src/types.ts',
  PluginEnablementRequest: 'signed Host plugin switch request is owned by packages/host/hosted-plugin-controls/src/types.ts',
  PluginEnablementResult: 'signed Host plugin switch result is owned by packages/host/hosted-plugin-controls/src/types.ts',
