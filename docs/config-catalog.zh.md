...
来源： [`packages/api/gateway/src/index.ts:150`](../packages/api/gateway/src/index.ts)
...
来源： [`packages/mobile/remote-host-v3/src/index.ts:82`](../packages/mobile/remote-host-v3/src/index.ts)
...
需要： `configEditor` · `profileContext`
...
来源： [`packages/settings/settings/src/index.ts:223`](../packages/settings/settings/src/index.ts)
...
来源： [`packages/web/web-search-brave/src/index.ts:21`](../packages/web/web-search-brave/src/index.ts)
...
这些插件通过没有 `config:` 块的 `cordis.yml` 条目加载；它们不声明配置 API。
...
- `@deepseek-ai/dsh-experimental-computer-use-policy` — 需要 `computerUse` · `tools` · `systemPrompt` ([`packages/experimental/computer-use-policy/src/index.ts`](../packages/experimental/computer-use-policy/src/index.ts))
...
- `@deepseek-ai/dsh-hosted-plugin-controls` — 需要 `hostedPluginState` · `loader` ([`packages/host/hosted-plugin-controls/src/index.ts`](../packages/host/hosted-plugin-controls/src/index.ts))
...
- `@deepseek-ai/dsh-progress-narration` — 需要 `systemPrompt` ([`packages/preset/progress-narration/src/index.ts`](../packages/preset/progress-narration/src/index.ts))
- `@deepseek-ai/dsh-remote-api` — 需要 `typertGateway` · `sessionController` · `workspaceController` · `sessions` · `agents` · `sessionProjections` ([`packages/mobile/remote-api/src/index.ts`](../packages/mobile/remote-api/src/index.ts))
...
抽象服务类：部署时加载具体实现包（[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。
