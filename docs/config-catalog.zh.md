...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-remote-gateway -->
<a id="deepseek-aidsh-remote-gateway"></a>

## `@deepseek-ai/dsh-remote-gateway`

- `inject`: `apiProxy` · `remoteDevices`
- `source`: [`packages/mobile/remote-gateway/src/index.ts:69`](../packages/mobile/remote-gateway/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-remote-gateway -->

<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-remote-host-v3 -->
<a id="deepseek-aidsh-remote-host-v3"></a>

## `@deepseek-ai/dsh-remote-host-v3`

- `inject`: `storageDomain` · `remoteDevices` · `remoteGateway`
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-remote-host-v3 -->
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-settings -->
<a id="deepseek-aidsh-settings"></a>

## `@deepseek-ai/dsh-settings`

- `inject`: `configEditor` · `profileContext`
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-settings -->
...
- `inject`: `web`
- `source`: [`packages/web/web-search-brave/src/index.ts:21`](../packages/web/web-search-brave/src/index.ts)
...
| `@deepseek-ai/dsh-experimental-computer-use-policy` | `computerUse` · `tools` · `systemPrompt` | [`packages/experimental/computer-use-policy/src/index.ts`](../packages/experimental/computer-use-policy/src/index.ts) |
...
| `@deepseek-ai/dsh-hosted-plugin-controls` | `hostedPluginState` · `loader` | [`packages/host/hosted-plugin-controls/src/index.ts`](../packages/host/hosted-plugin-controls/src/index.ts) |
...
| `@deepseek-ai/dsh-progress-narration` | `systemPrompt` | [`packages/preset/progress-narration/src/index.ts`](../packages/preset/progress-narration/src/index.ts) |
| `@deepseek-ai/dsh-remote-api` | `typertGateway` · `sessionController` · `workspaceController` · `sessions` · `agents` · `sessionProjections` | [`packages/mobile/remote-api/src/index.ts`](../packages/mobile/remote-api/src/index.ts) |
| `@deepseek-ai/dsh-remote-devices` | `storageDomain` | [`packages/mobile/remote-devices/src/index.ts`](../packages/mobile/remote-devices/src/index.ts) |
| `@deepseek-ai/dsh-remote-host-fd199` | `remoteHostV3` | [`packages/mobile/remote-host-fd199/src/index.ts`](../packages/mobile/remote-host-fd199/src/index.ts) |
| `@deepseek-ai/dsh-remote-host-identity` | `remoteDevices` | [`packages/mobile/remote-host-identity/src/index.ts`](../packages/mobile/remote-host-identity/src/index.ts) |
