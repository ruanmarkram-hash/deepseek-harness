...
- `@deepseek-ai/dsh-hosted-plugin-controls` — requires `hostedPluginState` · `loader` ([`packages/host/hosted-plugin-controls/src/index.ts`](../packages/host/hosted-plugin-controls/src/index.ts))
