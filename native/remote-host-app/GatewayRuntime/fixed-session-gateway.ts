...
function metadata(bytes: Uint8Array): Record<string, unknown> { const value = JSON.parse(decoder.decode(bytes)) as unknown; if (!isObject(value)) throw new Error('metadata invalid'); return value }
