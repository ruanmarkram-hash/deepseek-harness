...
The vendored archive, Minisign signature, public key, and recorded hashes are authoritative for this checkout. The download URL in `SOURCE.json` is provenance only and is not consulted during verification or builds.
